...
<link rel="canonical" href="http://ask.9939.com/hot/<{$pinyinKeywords}>/" >
    ...
    <header>
       ...
       <!--弹出 结束-->
        ...
        <section class="desech topad">
        	<input placeholder="请描述疾病或症状..." id = "searchWords" /><a href="" id = "searchBtn" >搜索</a>
	             ...
	             <div class="relate">
	                ...
	                <p>
	                	...
	                	<{else}>
	                		<span><i> </i> </span>	
	                	<{/if}>
	                	<span><i><{$val.ask.answernum}></i>个回答</span></p>
	                </div>
	             </div> 
