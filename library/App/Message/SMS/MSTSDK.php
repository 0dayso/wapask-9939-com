...
class App_Message_SMS_MSTSDK {
    ...
    public function content($content) {
        $this->_params['msg'] = iconv( "UTF-8", "gb2312//IGNORE" ,$content);//$content;  // iconv( "gb2312", "UTF-8//IGNORE" ,$content);
        return $this;
    }
    ...
    public function send() {
        ...
        $post_data = iconv( "UTF-8", "gb2312//IGNORE" ,$post_data);
        $ch = curl_init();
