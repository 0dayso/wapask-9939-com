...
class App_Model_ValidateCode {
   ...
   private $width;
    ...
    private function createImg()
    {
        ...
        $bgColor = imagecolorallocate($this->im, 226,226,226);
...
/*         for ($i = 0; $i <= 5; $i++) {
    ...
    private function createCode()
    {
        ...
        $_SESSION['check_num'] = strtolower($this->code);
    }
    ...
    private function setCaptcha()
    {
        ...
        for ($i = 0; $i < $this->codeNum; $i++) {
            $color = imagecolorallocate($this->im, 51, 51, 79);
